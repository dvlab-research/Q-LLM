...
# try:
llama3_tokenizer = AutoTokenizer.from_pretrained("/dataset-vlm/jingyaoli/LLMInfer/models/Meta-Llama-3-8B-Instruct")
...
conv_llava_llama_3 = Conversation(
    ...
    tokenizer_id="/dataset-vlm/jingyaoli/LLMInfer/models/Meta-Llama-3-8B-Instruct",
